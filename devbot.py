...
if choice == "n" or choice == "N":
    accessToken = input("What is your Webex token? ")
    accessToken = "Bearer " + accessToken
else:
	accessToken = "Bearer ODE3YWIyM2ItNTA5NS00OWIzLTgyZDItODZlYmJkMTNjMTAyMGJlOTg2NzAtZDAz_PC75_47fe537e-27d1-4e32-b2dc-2c26e4aa4fa0"
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "ryCzGbtqC5KhjT8pJsSgvdqEL5BkXMIU"
                               }
...
# 9. Provide the URL to the Sunrise/Sunset API.
        r = requests.get("https://api.sunrise-sunset.org/json?", # NEED TO CHANGE
...
# 10. Provide the Sunrise/Sunset key value for day_length.
        dayLength = json_data["results"]["day_length"]
        dayLengthSeconds = strptime(dayLength, "%H:%M:%S").tm_hour * 3600 + strptime(dayLength, "%H:%M:%S").tm_min * 60 + strptime(dayLength, "%H:%M:%S").tm_sec
